...
! -------------------------------------------------------------------------!
  ...
  subroutine Gauss_Seidel_redblack_OMP(u,comm,delta,irank,isize,coords,N,iter)
  real(dp), dimension(:,:,:), intent(inout) :: u
  integer,  intent(in) :: comm,irank,coords(3),N,iter,isize
  ...
  !$OMP parallel default(none) private(i,j,k,it,ierr) shared(u,comm,delta,irank,N,coords,iter,N_loc,isize) 
